...
public class MAdapter extends RecyclerView.Adapter<MAdapter.MyViewHolder2>{

    Context context2;
    ArrayList<FoodItem> list2;
    RecyclerView recyclerView;

    public MAdapter(Context context, ArrayList<FoodItem> list2) {
    ...
    @NonNull
    @Override
    public MAdapter.MyViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context2).inflate(R.layout.item,parent,false);
        return new MAdapter.MyViewHolder2(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MAdapter.MyViewHolder2 holder, int position) {
...
/*        holder.FoodName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context2, ClaimedDisplay.class);
        ...
        holder.deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("CONFIRM REMOVE EXPIRED FOOD");
